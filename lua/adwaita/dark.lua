...
local set_terminal_color = function()
	...
	vim.g.terminal_color_1 = colors.reg_4
	vim.g.terminal_color_2 = colors.green_5
	...
	vim.g.terminal_color_8 = colors.dark_2
	vim.g.terminal_color_9 = colors.red_1
	vim.g.terminal_color_10 = colors.green_3
	vim.g.terminal_color_11 = "#E9AD0C"
	vim.g.terminal_color_12 = "#2A7BDE"
	vim.g.terminal_color_13 = colors.purple_2
	vim.g.terminal_color_14 = "#33C7DE"
	vim.g.terminal_color_15 = colors.light_1
	vim.g.terminal_color_background = colors.libadwaita_dark
	vim.g.terminal_color_foreground = colors.light_1
end
...
M.set = function()
	...
	-- UI highlight
	hl("Normal", { fg = colors.light_1, bg = colors.libadwaita_dark })
